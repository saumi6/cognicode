...
import cogni
from cogni.core import config as b_config
from cogni.core import constants
from cogni.core import manager as b_manager
from cogni.core import utils
...
def _init_extensions():
    from cogni.core import extension_loader as ext_loader
...
def main():
    ...
    parser.add_argument(
        "--version",
        action="version",
        version=f"%(prog)s {cogni.__version__}\n"
