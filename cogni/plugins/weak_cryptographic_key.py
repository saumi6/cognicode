...
from cogni.core import test_properties as test
...
def _classify_key_size(config, key_type, key_size):
    ...
    key_sizes = {
        "DSA": [
            (config["weak_key_size_dsa_high"], cogni.HIGH),
            (config["weak_key_size_dsa_medium"], cogni.MEDIUM),
        ],
        "RSA": [
            (config["weak_key_size_rsa_high"], cogni.HIGH),
            (config["weak_key_size_rsa_medium"], cogni.MEDIUM),
        ],
        "EC": [
            (config["weak_key_size_ec_high"], cogni.HIGH),
            (config["weak_key_size_ec_medium"], cogni.MEDIUM),
        ],
    }
