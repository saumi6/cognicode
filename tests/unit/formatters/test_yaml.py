...
from cogni.formatters import json as b_json
...
class YamlFormatterTests(testtools.TestCase):
    def setUp(self):
        ...
        self.candidates = [
            issue.Issue(cogni.LOW, 123, cogni.LOW, "Candidate A", lineno=1),
            issue.Issue(cogni.HIGH, 123, cogni.HIGH, "Candiate B", lineno=2),
        ]
