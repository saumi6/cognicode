...
from cogni.core import metrics
from cogni.formatters import sarif
...
class SarifFormatterTests(testtools.TestCase):
    ...
    def test_report(self, get_issue_list):
        ...
        with open(self.tmp_fname) as f:
            ...
            self.assertEqual(cogni.__author__, driver["organization"])
            self.assertEqual(cogni.__version__, driver["semanticVersion"])
